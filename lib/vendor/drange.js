/*
 * Vendored from the `drange` npm package (version 2.0.1).
 * Upstream: https://github.com/fent/node-drange
 * License: MIT (see ./drange.LICENSE)
 *
 * Copied verbatim to remove an abandoned runtime dependency.
 */
